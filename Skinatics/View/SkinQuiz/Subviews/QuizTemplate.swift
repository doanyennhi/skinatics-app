...
struct QuizTemplate<Content: View>: View {
    ...
    @Binding var showUpdateError: Bool
    ...
    var body: some View {
        GeometryReader { geometry in 
            NavigationStack {
                ...
                .alert("Cannot update your information", isPresented: $showUpdateError, actions: {
...
struct QuizTemplate_Previews: PreviewProvider {
    static var previews: some View {
        QuizTemplate(title: "Any skin conditions?", subheading: "(Optional) Select any conditions you may have", show: false, options: conditions, selected: .constant(Set<String>()), screen: AppView().navigationBarBackButtonHidden(), btnText: "Submit", selectionOptional: true, action: {}, showUpdateError: .constant(false), errorMessage: .constant(""))
    }
}
